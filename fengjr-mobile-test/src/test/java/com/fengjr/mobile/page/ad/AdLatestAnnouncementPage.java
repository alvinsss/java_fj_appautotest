...
public class AdLatestAnnouncementPage implements LatestAnnouncementPage{
	
	private final static By BACK = By.id("com.fengjr.mobile:id/left");
	@SuppressWarnings("static-access")
	private final static By TITLE = By.id("com.fengjr.mobile:id/title").name("最新公告");
	
	public AdLatestAnnouncementPage() {
	...
	public boolean goHomPage(PageContext context) {
		goBack(context);
		context.setCurrentPage(PageFactory.createPage(HomePage.class));
		return false;
	}
