...
public class OsRepaymentPlanItem implements RepaymentPlanItem{
	
	// 日期
	private String date;
	private By DATE = By.id("repaymentDate");

	// 状态
	private String status;
	private By STATUS = By.id("repaymentStatus");
	
	// 还款金额
	private String amount;
	private By AMOUNT = By.id("repaymentAmount");
	
	public OsRepaymentPlanItem(WebElement uio) {
		try {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		OsRepaymentPlanItem other = (OsRepaymentPlanItem) obj;
		if (amount == null) {
