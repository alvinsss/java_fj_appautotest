...
public class OsLoanItem implements LoanItem{
	
	public final static By TITLE = By.id("loanItemTitle");
	public final static By RATE = By.id("loanItemRate");
	public final static By DURATION = By.id("loanItemDeadline");
	public final static By AMOUNT = By.id("loanItemAmount");
	public final static By STATE = By.id("loanIteminvestBtn");
	public final static By RESIDUE = By.id("loanItemResidue");
...
//	private LoanDetails details;
	...
	public OsLoanItem(WebElement uio) {
...
//	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		OsLoanItem other = (OsLoanItem) obj;
		if (title == null) {
			if (other.title != null)
				return false;
