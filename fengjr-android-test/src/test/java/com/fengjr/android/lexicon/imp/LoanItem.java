...
import com.fengjr.android.utils.Format;
...
public class LoanItem {
	...
	public LoanItem(WebElement uio) {
	...
	public boolean enterLoanDetails() {
		if (UiObject.searchFor(TITLE, true)) {
	...
	public String convertAmount(Loan loan) {
		return Format.getCurrencyCommontFormat(loan.amount);
	}
